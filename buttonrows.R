...
controlRow5 <- function(ctrlIds, ctrl_labels) {
  fluidRow(
    column(1,offset = 1,
           h4(ctrl_labels[1]),
           uiOutput(outputId = ctrlIds[1])
...
controlRow6 <- function(ctrlIds, ctrl_labels) {
  fluidRow(
    column(1,offset = 1,
           h4(ctrl_labels[1]),
           uiOutput(outputId = ctrlIds[1])
    ...
    column(1,offset = 1,
           h4(ctrl_labels[6]),
           uiOutput(outputId = ctrlIds[6])
    )
  ) #row
}


#another custom version we created
controlRow1_w_labels <- function(ctrlIds, ctrl_labels) {
  fluidRow(
    column(1,offset = 1,
           h4(ctrl_labels[1]),
           uiOutput(outputId = ctrlIds[1])
...
controlRow2_w_labels <- function(ctrlIds, ctrl_labels) {
  fluidRow(
    column(1,offset = 1,
           h4(ctrl_labels[1]),
           uiOutput(outputId = ctrlIds[1])
...
controlRow3_w_labels <- function(ctrlIds, ctrl_labels) {
  fluidRow(
    column(1,offset = 1,
           h4(ctrl_labels[1]),
           uiOutput(outputId = ctrlIds[1])
